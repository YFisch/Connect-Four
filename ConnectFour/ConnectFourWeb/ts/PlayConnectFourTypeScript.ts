...
let currentTurn = red;
let gameOver = true;
let msg: { text: (arg0: string) => void; };
let allCircles: Element[] = [];
let allEnterButtons: Element[] = [];
let winningSets: Element[][] = [];
let lstTokens1: Element[][] = [];
let lstTokens2: Element[][] = [];
let lstTokens3: Element[][] = [];
let lstTokens4: Element[][] = [];
let lstTokens5: Element[][] = [];
let lstTokens6: Element[][] = [];
let lstTokens7: Element[][] = [];
...
function getColumn(event: Event) {
...
function DetectWinner(lst: Element[]) {
